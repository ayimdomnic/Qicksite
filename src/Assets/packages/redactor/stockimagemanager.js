...
RedactorPlugins.stockimagemanager = function()
{
    return {
        getTemplate: function()
        {
            ...
            + '</span>'
            + '</div>'
            + '<div id="stockimagemanager-container" class="raw-block-300 quicksite-row raw-margin-top-24 raw-margin-bottom-24" style="overflow: scroll;"></div>'
            + '<div id="stockimagemanager-links" class="raw-block-20 quicksite-row"><button id="stockImgPrevBtn" class="btn btn-default pull-left">Prev</button><button id="stockImgNextBtn" class="pull-right btn btn-default">Next</button></div>'
        ...
        insert: function(e)
        {
            ...
            $.ajax({
                ...
                url: _url + '/quicksite/api/images/store',
                error: function(data){
                    console.log(data)
                },
                success: $.proxy(function(data) {
