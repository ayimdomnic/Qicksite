...
class TestCase extends Orchestra\Testbench\TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('quicksite.load-modules', false);
        ...
        $app['Illuminate\Contracts\Auth\Access\Gate']->define('quicksite', function ($user) {
            return true;
        });
    }
    /**
    ...
    {
        return [
            \Ayimdomnic\Quicksite\QuickSiteServiceProviderProvider::class,
    ...
    public function setUp()
    {
        ...
        $this->artisan('vendor:publish', [
            '--provider' => 'Yab\quicksite\quicksiteProvider',
            '--force'    => true,
        ]);
    ...
    */
    ...
    {
        $this->withoutMiddleware();
        $response = $this->call('GET', '/quicksite/dashboard');
